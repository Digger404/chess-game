...
class TurnAssertionTest {
    private final TurnAssertion turnAssertion = new TurnAssertion();
    ...
    void assertLegal() {
        ...
        assertThat(turnAssertion.assertLegal(state, b2c3)).isEmpty();
    }
    ...
    void assertIllegal() {
        ...
        assertThat(turnAssertion.assertLegal(state, b2c3))
